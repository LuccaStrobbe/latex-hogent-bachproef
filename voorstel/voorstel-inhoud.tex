...
aangezien deze fase de basis legt voor de rest van de pentest. Bij de handmatige uitvoering van deze fase, zal de stap te veel tijd kosten. 
...
AutoRecon, Recon-ng, Shodan en Nmap. Deze tools zijn ontwikkeld om robuust te zijn en het proces van de reconnaissance-fase te versnellen. ~\autocite{Shebli}
...
De resultaten van de analyse zullen de onderzoekers verder vergelijken op basis van enkele criteria zoals tijdsduur, nauwkeurigheid en gevonden kwetsbaarheden.
...
Het onderzoek zal concreet inzicht geven in hoe automatisatie de efficiëntie kan verbeteren in de reconnaissancefase van de pentest. 
De implementatie van een hybride model lijkt het efficiëntst waarbij het mogelijk is een geavanceerde tool en framework zoals AutoRecon, Shodan, Nmap en Reconng te gebruiken, gecombineerd met menselijke expertise. Dit zal er voor zorgen dat er een snellere, betrouwbaardere en nauwkeurigere verzameling van informatie is. Dit onderzoek zal bijdragen aan een meer efficiënte pentests, ook zal dit meer inzicht kunnen bieden in hoe organisaties tijd en kosten kunnen besparen zonder kwaliteitsverlies. De verwachte uitkomsten omvatten:

Het onderzoek zal concreet inzicht geven in hoe automatisatie de efficiëntie kan verbeteren in de reconnaissancefase van de 
pentest. De implementatie van een hybride model lijkt het efficiëntst
waarbij het mogelijk is een geavanceerde tool en framework zoals AutoRecon, Shodan, Nmap en Recon-ng te gebruiken,
