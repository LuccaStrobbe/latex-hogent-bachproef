...
De eerste fase binnen dit proces in de reconnaissance-fase, waar er zo veel mogelijk data wordt verzameld over het doelwit. Dit is een van de belangrijkste fases, 
...
Deze doelgroep is op zoek naar een betrouwbare tool dat efficiënte en een snelle werking heeft. 
%Deze literatuuronderzoek heeft betrekking op o.a.
Om dit te onderzoeken zal ik een literatuuronderzoek doen naar enkele bestaande tools waaronder 
...
tools nog veel handmatige inspanning om ze te integreren. Kothia heeft een geautomatiseerde aanpak gecrieert om deze tools
...
er de kwetsbaarheden uit kunnen halen en de kwedsbaarheden kunnen detecteren. Door automatisatie kunnen 
...
Vaak wordt een keuze gemaak tussen een handmatige of een geautomatiseerde penettest, deze keuze hangt vaak af van de specifieke  
...
bij het analyseren en prioriteren. Dit verhoogt da kans op menselijke fouten en is tijdintensief, ook zijn de testen vaak

inconsistent door de individuele voorkeuren van de pentester volgens ~\textcite{Ghanem}.


Binnen pentesting worden er nog vaak nieuwe technologieën ondekt en gebruikt, een van deze nieuwe technologieën is het gebruik van
...
- De Nauwkeurigheid van de ondekete gegevens.
- Het aantal gevonden unieke kwetsbaarheden.

Ook zullen er frameworks zoals OSTTMM en OWASp testing guid gebruit worden om de valideit van het onderzoek nog te vergroten.
...
\begin{enumerate}
    ...
    \item \textbf{Proof of Concept} (5 weken): De geautomatiseerde workflow wordt ontwikkeld en geimplementeerd.
