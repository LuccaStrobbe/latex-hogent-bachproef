...
Door de reconnaissance-fase op te splitsen in kleinere en duidelijke stappen, crieëert deze studie een betrouwbare manier om tools en frameworks te evalueren en toe te passen om de efficiëntie en effectiviteit te verbeteren.

\begin{itemize}
    \item Definieren van de scope: 
...
zal zijn waarbij het mogelijk is een geavanceerde tool en framework zoals AutoRecon, Shodan, Nmap en Recon-ng te gebruiken,
