...
Deze doelgroep is op zoek naar een betrouwbare tool dat efficiënt en een snelle werking heeft. 
...
\begin{itemize}
    \item Voor de verzamaling van informatie wordt er gebruik gemaakkt van Open-source frameworks waaronder AutoRecon, Nmap en Recon-ng.
