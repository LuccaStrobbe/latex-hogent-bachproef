...
\keywords{Automatisering,Proof-of-Concept,Penetratietests,Cybersecurity,Reconnaissance-fase,Kwetsbaarheidsanalyse} %ToDo
...
\begin{abstract}
  ...
  %Om de effectieviteit en impact van de geautomatiseerde reconnaissance-tools en frameworks te analyseren
  ...
  %te onderzoeken welke frameworks en tools de penetratietest kunnen verbeteren.  
